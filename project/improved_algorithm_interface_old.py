...
import requests
from Student_class_no_gender import Student_class_no_gender
...
def pref_in_group(student, group):
    lowest_pref_score_match = Student_class_no_gender("None", 0, -1, False, "")
    first_match = True
...
def get_students():
    ...
    for student in student_query:
        ...
        students.append(Student_class_no_gender(student.first_name, -1, -1, False, preference_query))
        count = count + 1
    return students
